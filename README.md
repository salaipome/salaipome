...
## What I do
- **Web development** — WordPress builds end-to-end (design, build, deploy), React, Next.js, TypeScript, Tailwind CSS, and Framer Motion build with AI-assisted development tools
- **Digital marketing** — SEO, Google Ads, CRM & marketing automation, lead generation
- **Data analytics** — Python, Pandas, Scikit-learn — turning campaign and customer data into decisions, not just dashboards
...
Fun facts
☕️ I love coffee
🎸 I play guitar and produce music for Echo of Grace


## Get in touch
🔗 [linkedin.com/in/salaihang](https://linkedin.com/in/salaihang)
🥷🏽 https://salaipome.github.io/portfolio/
